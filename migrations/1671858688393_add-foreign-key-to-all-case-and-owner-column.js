...
exports.up = (pgm) => {
  ...
  pgm.addConstraint(
    ...
    'FOREIGN KEY(case1) REFERENCES cards(card_id) ON DELETE CASCADE'
  );

  pgm.addConstraint(
    'showcases',
    'fk_showcases.case2_cards.card_id',
    'FOREIGN KEY(case2) REFERENCES cards(card_id) ON DELETE CASCADE'
  );

  pgm.addConstraint(
    'showcases',
    'fk_showcases.case3_cards.card_id',
    'FOREIGN KEY(case3) REFERENCES cards(card_id) ON DELETE CASCADE'
  );

  pgm.addConstraint(
    'showcases',
    'fk_showcases.case4_cards.card_id',
    'FOREIGN KEY(case4) REFERENCES cards(card_id) ON DELETE CASCADE'
  );

  pgm.addConstraint(
    'showcases',
    'fk_showcases.case5_cards.card_id',
    'FOREIGN KEY(case5) REFERENCES cards(card_id) ON DELETE CASCADE'
  );

  pgm.addConstraint(
    'showcases',
    'fk_showcases.case6_cards.card_id',
    'FOREIGN KEY(case6) REFERENCES cards(card_id) ON DELETE CASCADE'
  );
};

exports.down = (pgm) => {
  pgm.dropConstraint('showcases', 'fk_verifications.owner_users.id');
